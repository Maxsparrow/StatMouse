<?php include('inc/header.php'); ?>
	...
	<div id="championsbody">
		...
		<?php			
	    		...
	    		if($page>0) {
	    			echo "<p><a href='champion.php?champion=".htmlentities($champion, ENT_QUOTES)."&pg=".($page-1)."' style='color: black;' > Previous Page </a></p>";
	    		} else { 
	    			echo "</br>";
	    		}
	    		if (count($results)==$numPerPage) {
	    			echo "<p><a href='champion.php?champion=".htmlentities($champion, ENT_QUOTES)."&pg=".($page+1)."' style='color: black;' > Next Page </a></p>";
	    		} else { 
	    			echo "</br>";
	    		}
	    	?>	
